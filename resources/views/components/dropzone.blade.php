@props(['label'=>'', 'model'=>'', 'fileurl'=>null, 'inline'=>'true'])
...
>
    ...
    <div id="file-upload" class="block w-full py-2 px-3 relative appearance-none border border-gray-300
         rounded-md dark:bg-darker dark:border-gray-600"
    ...
    <template x-if="file === null">
        <div class="flex flex-col space-y-2 items-center justify-center">
            ...
            @endif
            <x-button color="primary">Select a file</x-button>
        </div>
    </template>
